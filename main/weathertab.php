...
<body>
  ...
  <div class="container">
    ...
    label.addEventListener("click", function() {
      ...
      let link; 
      if (id === "Seoul") {
        link = "weather.php?weather=<?php echo "서울";?>";
      } else if (id === "Busan") {
        link = "weather.php?weather=<?php echo "부산";?>";
      } else if (id === "Daegu") {
        link = "weather.php?weather=<?php echo "대구";?>";
        
      } else if (id === "Incheon") {
        link = "weather.php?weather=<?php echo "인천";?>";
      } else if (id === "Gwangju") {
        link = "weather.php?weather=<?php echo "광주";?>";
      } else if (id === "Daejeon") {
        link = "weather.php?weather=<?php echo "대전";?>";
      } else if (id === "Ulsan") {
        link = "weather.php?weather=<?php echo "울산";?>";
      } else if (id === "Sejong") {
        link = "weather.php?weather=<?php echo "세종";?>";
      } else if (id === "Gyeonggi") {
        link = "weather.php?weather=<?php echo "경기";?>";
      } else if (id === "Gangwon") {
        link = "weather.php?weather=<?php echo "강원";?>";
      } else if (id === "Chungbuk") {
        link = "weather.php?weather=<?php echo "충북";?>";
      } else if (id === "Chungnam") {
        link = "weather.php?weather=<?php echo "충남";?>";
      } else if (id === "Jeonbuk") {
        link = "weather.php?weather=<?php echo "전북";?>";
      } else if (id === "Jeonnam") {
        link = "weather.php?weather=<?php echo "전남";?>";
      } else if (id === "Gyeongbuk") {
        link = "weather.php?weather=<?php echo "경북";?>";
      } else if (id === "Gyeongnam") {
        link = "weather.php?weather=<?php echo "경남";?>";
      } else if (id === "Jeju") {
        link = "weather.php?weather=<?php echo "제주";?>";
      }
