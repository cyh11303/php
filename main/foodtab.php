...
<div class="path">
  ...
  <a href=""> 맛집</a>
    ...
    document.getElementById(id).checked = true;
      ...
      let link; 
      if (id === "Seoul") {
        link = "foodtab1.php?a=<?php echo "서울";?>";
      } else if (id === "Busan") {
        link = "foodtab1.php?a=<?php echo "부산";?>";
      } else if (id === "Daegu") {
        link = "foodtab1.php?a=<?php echo "대구";?>";
        
      } else if (id === "Incheon") {
        link = "foodtab1.php?a=<?php echo "인천";?>";
      } else if (id === "Gwangju") {
        link = "foodtab1.php?a=<?php echo "광주";?>";
      } else if (id === "Daejeon") {
        link = "foodtab1.php?a=<?php echo "대전";?>";
      } else if (id === "Ulsan") {
        link = "foodtab1.php?a=<?php echo "울산";?>";
      } else if (id === "Sejong") {
        link = "foodtab1.php?a=<?php echo "세종";?>";
      } else if (id === "Gyeonggi") {
        link = "foodtab1.php?a=<?php echo "경기";?>";
      } else if (id === "Gangwon") {
        link = "foodtab1.php?a=<?php echo "강원";?>";
      } else if (id === "Chungbuk") {
        link = "foodtab1.php?a=<?php echo "충북";?>";
      } else if (id === "Chungnam") {
        link = "foodtab1.php?a=<?php echo "충남";?>";
      } else if (id === "Jeonbuk") {
        link = "foodtab1.php?a=<?php echo "전북";?>";
      } else if (id === "Jeonnam") {
        link = "foodtab1.php?a=<?php echo "전남";?>";
      } else if (id === "Gyeongbuk") {
        link = "foodtab1.php?a=<?php echo "경북";?>";
      } else if (id === "Gyeongnam") {
        link = "foodtab1.php?a=<?php echo "경남";?>";
      } else if (id === "Jeju") {
        link = "foodtab1.php?a=<?php echo "제주";?>";
      }
