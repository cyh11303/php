      ...
      <ul>
        ...
        <a href="naver1.php?&location=맛집 TOP5&weather=<?php echo "서울";?>&page=1">서울</a>
          <ul>
            ...
            <li><a href="naver1.php?&location=맛집 TOP5&weather=<?php echo "중구";?>&page=1">중구</a></li>
        ...
        <li>
          ...
          <ul>
            ...
            <li><a href="naver1.php?&location=맛집 TOP5&weather=<?php echo "전라북도 임실군";?>&page=1">임실</a></li>
            <li><a href="naver1.php?&location=맛집 TOP5&weather=<?php echo "전라북도 장수군";?>&page=1">장수</a></li>
            <li><a href="naver1.php?&location=맛집 TOP5&weather=<?php echo "전라북도 전주시";?>&page=1">전주</a></li>
            <li><a href="naver1.php?&location=맛집 TOP5&weather=<?php echo "전라북도 정읍시";?>&page=1">정읍</a></li>
            <li><a href="naver1.php?&location=맛집 TOP5&weather=<?php echo "전라북도 진안군";?>&page=1">진안</a></li>
          </ul>
        </li>
        <li>
        ...
        <li>
          ...
          <ul>
            ...
            <li><a href="naver1.php?&location=맛집 TOP5&weather=<?php echo "경상남도 함천군";?>&page=1">합천</a></li>
          </ul>
        </li>
        <li>
          <a href="naver1.php?&location=맛집 TOP5&weather=<?php echo "전라북도";?>&page=1">전북</a>
