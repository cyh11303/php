...
<nav aria-label="Page navigation example">
  <ul class="pagination">
  <li class="page-item"><a class="page-link" href="pro2.php?b=<?php echo $_GET["b"];?>&a=<?php echo $_GET["a"];?>&search=<?php echo $_GET["search"];?>&location=키워드&page=1">First</a></li>

    <?php
      if($prev_page > 1) {
        echo '<li class="page-item"><a class="page-link" href="pro2.php?b='.$_GET["b"].'&a='.$_GET["a"].'&search='.$_GET["search"].'&location=키워드&page='.$prev_page.'">Prev</a></li>';
      }
      ...
      for($i = $start_page; $i <= $end_page; $i++) {
        if($i == $page) {
          ...
          echo '<li class="page-item"><a class="page-link" href="pro2.php?b='.$_GET["b"].'&a='.$_GET["a"].'&search='.$_GET["search"].'&location=키워드&page='.$i.'">'.$i.'</a></li>';  
      ...
      if($next_page <= $total_page) {
        echo '<li class="page-item"><a class="page-link" href="pro2.php?b='.$_GET["b"].'&a='.$_GET["a"].'&search='.$_GET["search"].'&location=키워드&page='.$next_page.'">Next</a></li>';
      }


      if($page < $total_page) {
        echo '<li class="page-item"><a class="page-link" href="pro2.php?b='.$_GET["b"].'&a='.$_GET["a"].'&search='.$_GET["search"].'&location=키워드&page='.$total_page.'">Last</a></li>';
      }
